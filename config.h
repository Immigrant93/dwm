...
static const char *prtsccmd[] = {"scrot", "%Y.%m.%d-$wx$h.png", "--quality", "100", "-e", "'mv $f ~/Pictures/screenshots/'",  NULL};
...
static Key keys[] = {
	...
	{ KeyPress, 0, XF86XK_AudioMute, spawn, {.v = volmutecmd} },
	{ KeyRelease, 0, XK_Print, spawn, {.v = prtsccmd} },
	{ KeyPress, ShiftMask, XK_Print, spawn, {.v = scrot} },
};
